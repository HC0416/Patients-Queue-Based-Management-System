...
int main() {
    ...
    nurse->insertNode(wNode);
    hNode = doctor->createNode("P0001", "Levi", "Arkerman", 33, "male", "0124353214", "No. 59", "Street A", 13412, "City A", "State A", "A", 21, 8, 2021, 11, 34, true, "Allergies", "Doctor Chong", "Allergy shots");
    doctor->insertNode(hNode);
    hNode = doctor->createNode("P0002", "Erwin", "Smith", 50, "male", "0124453214", "No. 23", "Street A", 13412, "City A", "State A", "A", 21, 8, 2021, 12, 35, false, "Cold and Flu", "Doctor Chong", "Anti-flu medicines");
    doctor->insertNode(hNode);
    hNode = doctor->createNode("P0003", "Reiner", "Braun", 32, "male", "0124356765", "No. 43", "Street A", 13412, "City A", "State A", "A", 21, 8, 2021, 12, 36, false, "Cough", "Doctor Chong", "cough suppressant");
    doctor->insertNode(hNode);
    hNode = doctor->createNode("P0004", "Connie", "Springer", 20, "male", "0198973214", "No. 56", "Street B", 13416, "City B", "State B", "A", 21, 8, 2021, 12, 46, true, "Sore Throat", "Doctor Chong", "Antibiotics");
    doctor->insertNode(hNode);
    hNode = doctor->createNode("P0005", "Historia", "Reiss", 19, "female", "0174543214", "No. 21", "Street C", 13416, "City C", "State C", "A", 21, 8, 2021, 13, 45, false, "Fever", "Doctor Chong", "Aspirin");
    doctor->insertNode(hNode);
    hNode = doctor->createNode("P0001", "Levi", "Arkerman", 33, "male", "0124353214", "No. 59", "Street A", 13412, "City A", "State A", "A", 21, 8, 2021, 14, 45, true, "Allergies", "Doctor Chong", "Allergy shots");
    doctor->insertNode(hNode);
    mainMenu();
    return 0;
}
